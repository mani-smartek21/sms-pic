    ...
    <head>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                <?php
                $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, spmoview-font.css') // CSS Files
                        ->addJS('bootstrap.min.js, jquery.sticky.js, smoothscroll.js, main.js') // JS Files
                        ->lessInit()->setLessVariables(array(
                            'preset' => $this->helix3->Preset(),
                            'bg_color' => $this->helix3->PresetParam('_bg'),
                            'text_color' => $this->helix3->PresetParam('_text'),
                            'header_bg' => $this->helix3->PresetParam('_header_bg'),
                            'border_color' => $this->helix3->PresetParam('_border_color'),
                            'major_color' => $this->helix3->PresetParam('_major'),
                            'review_box_bg' => $this->helix3->PresetParam('_review_box_bg'),
                            'menu_bg' => $this->helix3->PresetParam('_menu_bg')
                        ))
